...
void _scheduleItemSerialize(
  ...
  writer.writeBoolList(offsets[1], object.daysOfWeek);
...
ScheduleItem _scheduleItemDeserialize(
  ...
  final object = ScheduleItem(
    ...
    daysOfWeek: reader.readBoolList(offsets[1]) ?? [],
...
extension ScheduleItemQuerySortBy
  ...
  QueryBuilder<ScheduleItem, ScheduleItem, QAfterSortBy> sortByDateTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'dateTime', Sort.asc);
    });
  }

  QueryBuilder<ScheduleItem, ScheduleItem, QAfterSortBy> sortByDateTimeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'dateTime', Sort.desc);
    });
  }

  QueryBuilder<ScheduleItem, ScheduleItem, QAfterSortBy> sortByDescription() {
    return QueryBuilder.apply(this, (query) {
...
extension ScheduleItemQuerySortThenBy
  ...
  QueryBuilder<ScheduleItem, ScheduleItem, QAfterSortBy> thenByDateTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'dateTime', Sort.asc);
    });
  }

  QueryBuilder<ScheduleItem, ScheduleItem, QAfterSortBy> thenByDateTimeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'dateTime', Sort.desc);
    });
  }

  QueryBuilder<ScheduleItem, ScheduleItem, QAfterSortBy> thenByDescription() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'description', Sort.asc);
    });
  }
...
extension ScheduleItemQueryWhereDistinct
  ...
  QueryBuilder<ScheduleItem, ScheduleItem, QDistinct> distinctByDateTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'dateTime');
    });
  }

  QueryBuilder<ScheduleItem, ScheduleItem, QDistinct> distinctByDaysOfWeek() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'daysOfWeek');
    });
  }

  QueryBuilder<ScheduleItem, ScheduleItem, QDistinct> distinctByDescription(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension ScheduleItemQueryProperty
  ...
  QueryBuilder<ScheduleItem, DateTime, QQueryOperations> dateTimeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'dateTime');
    });
  }

  QueryBuilder<ScheduleItem, List<bool>, QQueryOperations>
      daysOfWeekProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ScheduleItem, String, QQueryOperations> descriptionProperty() {
    return QueryBuilder.apply(this, (query) {
